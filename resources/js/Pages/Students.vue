                        ...
                        <div class=" space-y-10">
                            ...
                            <div class="">
                                ...
                                <div v-if="students.length >0">
                                    <div v-for="(view, i ) in students" :key="i" class="grid md:grid-cols-5 grid-cols-3 gap-2 mb-2 w-full justify-items-center items-center shadow-sm bg-white h-16">
            ...
            <div class="bg-white shadow-xl rounded-lg w-96 ">
                <div class="w-11/12 py-4 mx-auto space-y-4">
                    <div class="flex flex-col gap-2">
                        <div class="rounded-lg overflow-hidden w-32 h-40">
                            <img :src="`/storage/students/${viewData.picture}`" class="h-full" alt="Logo">
                        </div>
                         <div>
                             <p class=" capitalize">full name</p>
                        <p class="font-bold capitalize text-xl">{{ viewData.firstname + ' ' + viewData.lastname}}</p>
                         </div>
                    </div>
                    ...
                    <div class="space-y-4 ">
                        ...
                        <div class="flex gap-3">
                            <p class="capitalize"> amount:</p>
                            <p>{{ viewData.amount }}</p>
                        </div>

                        <div class="flex gap-3">
                            <p class="capitalize"> day's of training:</p>
                            <p>{{ viewData.days }}</p>
                        </div>
...
import { useToast } from 'vue-toastification'
    ...
    export default defineComponent({
        ...
        methods:{
            delstudent(id){
               if (confirm('are sure you want to delete student details!')) {
